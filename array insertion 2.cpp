...
Enter the size of Array : 9 How number of element to insert in to array :2 Enter 2 number of element : 12 23 12 23 0 0 0 0 0 0 0 Enter the number to insert in to array: 44 The Element 44 inserted at the location : 8 12 23 0 0 0 0 0 44 0
*/
#include<iostream>
using namespace std;
